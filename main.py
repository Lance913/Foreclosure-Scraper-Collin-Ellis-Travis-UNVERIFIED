"""
Main orchestrator — Foreclosure Scraper (Collin, Ellis, Travis)

Sister system to Lance913/Scraper_Python (Harris/Bexar/Dallas/Tarrant/Denton/
Johnson) — same architecture, additional/different counties, writes to the
'Foreclosure Leads' + 'Foreclosure Daily Counts' tabs of a separate sheet.

Usage:
  python main.py                              # all counties, today
  python main.py --date 2026-06-25             # specific date
  python main.py --counties collin ellis       # specific counties
...
def parse_args():
    p = argparse.ArgumentParser(description='Foreclosure Scraper — Collin/Ellis/Travis')
...
def main():
    ...
    logger.info(f"=== Foreclosure Scraper (Collin/Ellis/Travis) | {target_date} ===")
